 ...
 * 版权所有，侵权必究！
 */
package com.leiyue.mall.controller.mall;

import com.leiyue.mall.controller.vo.NewBeeMallOrderDetailVO;
import com.leiyue.mall.controller.vo.NewBeeMallUserVO;
import com.leiyue.mall.common.Constants;
import com.leiyue.mall.common.NewBeeMallException;
import com.leiyue.mall.common.NewBeeMallOrderStatusEnum;
import com.leiyue.mall.common.ServiceResultEnum;
import com.leiyue.mall.controller.vo.NewBeeMallShoppingCartItemVO;
import com.leiyue.mall.entity.NewBeeMallOrder;
import com.leiyue.mall.service.NewBeeMallOrderService;
import com.leiyue.mall.service.NewBeeMallShoppingCartService;
import com.leiyue.mall.util.PageQueryUtil;
import com.leiyue.mall.util.Result;
import com.leiyue.mall.util.ResultGenerator;
...
public class OrderController {
    ...
    @GetMapping("/payPage")
    public String payOrder(HttpServletRequest request, @RequestParam("orderNo") String orderNo,
                           HttpSession httpSession, @RequestParam("payType") int payType) {
        NewBeeMallUserVO user = (NewBeeMallUserVO) httpSession.getAttribute(Constants.MALL_USER_SESSION_KEY);
        NewBeeMallOrder newBeeMallOrder = newBeeMallOrderService.getNewBeeMallOrderByOrderNo(orderNo);
        //判断订单userId
        if (!user.getUserId().equals(newBeeMallOrder.getUserId())) {
